// lib/src/features/navigation/views/navigation_mobile_view.dart
...
class NavigationHubMobileScreen extends ConsumerWidget implements NavigationHubScreen {
  final Widget child;
  const NavigationHubMobileScreen({super.key, required this.child});
    ...
    return Container(
      ...
      child: Center(
        child: Text(
          ...
          style: theme.whiteTextTheme.font1.copyWith(fontWeight: FontWeight.w900),
        ),
      ),
    );
  }
        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: Image.asset('assets/images/logo-prest.jpeg', height: 30, color: theme.colors.black, colorBlendMode: BlendMode.srcIn),
            ),
  ...
  Widget _drawerItem(PrestThemeData theme, String title, IconData icon) {
    return ListTile(
      ...
      title: Text(title, style: theme.blackTextTheme.font5.copyWith(fontWeight: FontWeight.w600)),
      onTap: () {},
    );
  }
}
