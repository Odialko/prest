...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is OfferState);
}
...
/// @nodoc
class $OfferStateCopyWith<$Res>  {
$OfferStateCopyWith(OfferState _, $Res Function(OfferState) __);
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loading,TResult Function( String message)?  error,TResult Function( OfferModel offer)?  loaded,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Loading() when loading != null:
return loading();case _Error() when error != null:
return error(_that.message);case _Loaded() when loaded != null:
return loaded(_that.offer);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loading,required TResult Function( String message)  error,required TResult Function( OfferModel offer)  loaded,}) {final _that = this;
switch (_that) {
case _Loading():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loading,TResult? Function( String message)?  error,TResult? Function( OfferModel offer)?  loaded,}) {final _that = this;
switch (_that) {
case _Loading() when loading != null:
return loading();case _Error() when error != null:
return error(_that.message);case _Loaded() when loaded != null:
...
class _Loading implements OfferState {
  const _Loading();
...
class _Error implements OfferState {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $OfferStateCopyWith<$Res> {
...
class _Loaded implements OfferState {
  const _Loaded(this.offer);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Loaded&&(identical(other.offer, offer) || other.offer == offer));
}
...
@override
String toString() {
  return 'OfferState.loaded(offer: $offer)';
}
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $OfferStateCopyWith<$Res> {
